        ...
        easeUI.getNotifier().setNotificationInfoProvider(new EaseNotificationInfoProvider() {
            ...
            public Intent getLaunchIntent(EMMessage message) {
                ...
                if ("1".equals(type)) {
                    ...
                    ConversationBean.MsgBean msgBean = LvShiDao.getInstance(appContext).selectById(toUserId);
                    String toUserName = msgBean.getName();
                    String toUserAvatar = msgBean.getPicurl();
                    return UserChatRoomActivity.getStartIntent(appContext, false, true,
                    ...
                    String toUserName = msgBean.getName();
                    String toUserAvatar = msgBean.getPicurl();
                    return LawyerChatRoomActivity.getStartIntent(appContext, true,
                            toUserId, toUserName, toUserAvatar, "");
                }


//                Intent intent = new Intent(appContext, UserChatRoomActivity.class);
...
//                        intent.putExtra("chatType", AppConstant.CHATTYPE_SINGLE);
//                    } else { // group chat message
//                        // message.getTo() is the group id
//                        intent.putExtra("userId", message.getTo());
//                        if (chatType == ChatType.GroupChat) {
//                            intent.putExtra("chatType", AppConstant.CHATTYPE_GROUP);
//                        } else {
//                            intent.putExtra("chatType", AppConstant.CHATTYPE_CHATROOM);
//                        }
//                    }
//                }
//                return intent;
...
//                break;
    ...
    protected void onUserException(String exception) {
        ...
        String type = SpUtil.getString(AppConstant.SHENFEN, "");
        if ("1".equals(type)) {
...
//        appContext.startActivity(intent);
     ...
     * activityList.size() <= 0 means all activities already in background or not in ActivityZhiYeJiGou Stack
     */
...
//                    String userName = message.getStringAttribute("hxid_nickname", "");
//                    String userPic = message.getStringAttribute("hxid_avatar", "");
...
//                    EventBus.getDefault().post(new MessageEvent("newMessage"));
                    // 判断一下是否是会议邀请
                    String confId = message.getStringAttribute(AppConstant.MSG_ATTR_CONF_ID, "");
                    if (!"".equals(confId)) {
                        String password = message.getStringAttribute(AppConstant.MSG_ATTR_CONF_PASS, "");
                        String extension = message.getStringAttribute(AppConstant.MSG_ATTR_EXTENSION, "");
                        goConference(confId, password, extension);
                    }
